...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .status { min-height: 20px; margin-top: 16px; color: #7d86ff; font-size: 12px; }
  </style>
</head>
<body>
  ...
  <script>
    function loginWithGitHub() {
      document.getElementById('status').textContent = 'Тут буде підключення бекенд-маршруту для GitHub OAuth 🚀';
    }
  </script>
</body>
</html>"""
